...
func (r SendPhotoRequest) Fields() map[string]any {
	...
	if r.CallbackQueryID != "" {
		m["callback_query_id"] = r.CallbackQueryID
	}
	m["photo"] = r.Photo
	if r.Caption != "" {
		m["caption"] = r.Caption
...
// SendVideoNoteRequest holds the parameters of the "sendVideoNote" method. As of v.4.0, Telegram
// clients support rounded square MPEG4 videos of up to 1 minute long. Use this method to send
